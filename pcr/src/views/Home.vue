      ...
      <a-row :gutter="24">
        <a-col :span="3">
          <a-form-item label="当前值：">
            <a-input-number v-model="currentLevel" :min="1" :max="maxLevel" @change="onChange" />
          </a-form-item>
        </a-col>
        <a-col :span="3">
...
export default {
  ...
  methods: {
    ...
    calExp() {
      ...
      // 经验差
      let offsetExp = targetExp - currentExp;
      console.log("offsetExp", offsetExp);
      this.result = offsetExp;
    }
  },
  created() {
    this.calExp();
